...
### Install Options:
  *Note: if you want to use MQTT, you will need to use the ESPHome Dashboard.*
  ...
  1. Download the `yet-another-smart-vent.bin` file from [Releases](https://github.com/TonyBrobston/yet-another-smart-vent/releases).
  ...
  7. Click `INSTALL`.
  8. Click `Choose File`.
  9. Select the `yet-another-smart-vent.bin` file you downloaded in step #1.
  10. Click `INSTALL`.
